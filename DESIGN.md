...
- [ ] License/asset source for distributing Geist outside the local Electron environment; it is installed on the operator workstation but is not bundled in Git.
