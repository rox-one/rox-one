...
async function getExpectedCoreChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@craft-agent/server-core/handlers/rpc/openclaw'),
    import('@craft-agent/server-core/handlers/rpc/command-gateway'),
    import('@craft-agent/server-core/handlers/rpc/notes-import'),
    import('@craft-agent/server-core/handlers/rpc/fabric'),
    import('@craft-agent/server-core/handlers/rpc/session-foreign-import'),
    ...
    import('@craft-agent/server-core/handlers/rpc/memory-proposals'),
    import('@craft-agent/server-core/handlers/rpc/meetings'),
    import('@craft-agent/server-core/handlers/rpc/personal-tasks'),
    import('@craft-agent/server-core/handlers/rpc/browser-profile-import'),
    ...
    import('@craft-agent/server-core/handlers/rpc/voice'),
    import('@craft-agent/server-core/handlers/rpc/environment'),
  ...
  return new Set([
    ...
    ...personalTasks.HANDLED_CHANNELS,
