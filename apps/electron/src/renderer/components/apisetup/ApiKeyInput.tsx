...
const ANTHROPIC_PRESETS: Preset[] = [
  ...
  { key: 'minimax-global', label: 'Minimax Global', url: 'https://api.minimax.io/anthropic', placeholder: '__pasteKeyHere__', piOnly: true },
  { key: 'minimax-cn', label: 'Minimax CN', url: 'https://api.minimaxi.com/anthropic', placeholder: '__pasteKeyHere__', piOnly: true },
...
const PI_PRESETS: Preset[] = [
  { key: 'pi', label: 'Rox Backend (Direct)', url: '' },
