  ...
  return (
    <>
      <button
        ...
        className="absolute top-2 right-2 z-20 flex h-6 items-center gap-1 rounded-[6px] px-1.5 text-xs text-muted-foreground/70 hover:bg-foreground/5 hover:text-muted-foreground"
      >
