...
describe('CF-6.2 ConnectionsPage', () => {
  ...
  it('offers test and repair on credential rows without stealing focus', () => {
    ...
    expect(page).toContain('data-testid="connections-row-test"')
    expect(page).toContain('data-testid="connections-credential-test"')
    expect(page).toContain('data-testid="connections-policy-test"')
    expect(page).toContain('data-testid="connections-row-repair"')
    expect(page).toContain('data-testid="connections-credential-repair"')
    expect(page).toContain('data-testid="connections-policy-repair"')
