...
export const mockElectronAPI = {
  ...
  requestPrivacyExport: async () => ({
    ...
    migratedAt: 0,
    updatedAt: 0,
    exportReceipt: { id: 'export-playground', requestedAt: 0, completedAt: 0, path: '/tmp/rox-privacy.json', excluded: ['credentials', 'cookies', 'passkeys'] as const },
  }),
  requestPrivacyDeletion: async () => ({
    schemaVersion: 'dg-01-v1',
    purposes: {
      accountRecoveryReplica: false,
      realtimeSync: false,
    ...
    exports: [],
    deletions: [],
    latestDeletion: { id: 'deletion-playground', status: 'queued' as const, requestedAt: 0, localDataKept: true as const, remoteSla: 'queued-immediately' as const, purposes: [] },
    migratedAt: 0,
    updatedAt: 0,
    deletionReceipt: { id: 'deletion-playground', status: 'queued' as const, requestedAt: 0, localDataKept: true as const, remoteSla: 'queued-immediately' as const, purposes: [] },
  }),
  completePrivacyDeletion: async () => ({
    schemaVersion: 'dg-01-v1',
    purposes: {
      accountRecoveryReplica: false,
      realtimeSync: false,
  ...
  loadPresetThemes: async () => [
    { id: 'pierre', path: '/mock/pierre.json', theme: { name: 'Pierre' } },
    { id: 'github', path: '/mock/github.json', theme: { name: 'GitHub' } },
    { id: 'ghostty', path: '/mock/ghostty.json', theme: { name: 'Ghostty' } },
