...
const EXPECTED_CHANNELS: string[] = [
  ...
  'copilot:logout',
  'copilot:startOAuth',
  'credentials:applyMigration',
  'credentials:getMigrationStatus',
  'credentials:healthCheck',
  'credentials:previewMigration',
  'credentials:rollbackMigration',
  'debug:log',
  'deeplink:navigate',
  'dialog:openFolder',
  'drafts:delete',
  ...
  'extensionHost:listCapabilities',
  ...
  'fabric:acquireLease',
  'fabric:commitImport',
  'fabric:createConnection',
  'fabric:discover',
  'fabric:githubStatus',
  'fabric:infisicalHealth',
  'fabric:listAudit',
  'fabric:listConnections',
  'fabric:listCredentials',
  'fabric:listGrants',
  'fabric:preview',
  'fabric:putGrant',
  'fabric:revokeConnection',
  ...
  'knowledge:unwatch',
  'knowledge:updateConnection',
  'knowledge:userCreate',
  'knowledge:viewRun',
  ...
  'marketplace:update',
  'meetingAgents:ask',
  'meetingAgents:configure',
  'meetingAgents:list',
  'meetingAgents:readiness',
  'meetingAgents:runSkill',
  'meetingProposals:approve',
  'meetingProposals:clarify',
  'meetingProposals:execute',
  'meetingProposals:list',
  'meetingProposals:reject',
  'meetingProposals:status',
  ...
  'memory:changed',
  'memory:deleteLesson',
  'memory:deleteProposal',
  'memory:editProposal',
  'memory:export',
  'memory:extractProposals',
  'memory:getContext',
