...
export const CHANNEL_MAP = {
  ...
  bootstrapVoice: invoke(RPC_CHANNELS.voice.BOOTSTRAP),
  getVoiceCapabilities: invoke(RPC_CHANNELS.voice.CAPABILITIES),
  startVoiceCapture: invoke(RPC_CHANNELS.voice.START),
  stopVoiceCapture: invoke(RPC_CHANNELS.voice.STOP),
