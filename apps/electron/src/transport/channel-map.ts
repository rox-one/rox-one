...
export const CHANNEL_MAP = {
  ...
  pauseMeeting: invoke(RPC_CHANNELS.meetings.PAUSE),
  resumeMeeting: invoke(RPC_CHANNELS.meetings.RESUME),
  stopMeetingSession: invoke(RPC_CHANNELS.meetings.STOP),
  listMeetingSegments: invoke(RPC_CHANNELS.meetings.SEGMENTS),
  subscribeMeeting: invoke(RPC_CHANNELS.meetings.SUBSCRIBE),
  correctMeetingSegment: invoke(RPC_CHANNELS.meetings.CORRECT_SEGMENT),
  addMeetingManualNote: invoke(RPC_CHANNELS.meetings.ADD_MANUAL_NOTE),
  listMeetingAgents: invoke(RPC_CHANNELS.meetingAgents.LIST),
  configureMeetingAgent: invoke(RPC_CHANNELS.meetingAgents.CONFIGURE),
  meetingAgentReadiness: invoke(RPC_CHANNELS.meetingAgents.READINESS),
  askMeetingAgent: invoke(RPC_CHANNELS.meetingAgents.ASK),
  runMeetingSkill: invoke(RPC_CHANNELS.meetingAgents.RUN_SKILL),
  listMeetingProposals: invoke(RPC_CHANNELS.meetingProposals.LIST),
  clarifyMeetingProposal: invoke(RPC_CHANNELS.meetingProposals.CLARIFY),
  approveMeetingProposal: invoke(RPC_CHANNELS.meetingProposals.APPROVE),
  rejectMeetingProposal: invoke(RPC_CHANNELS.meetingProposals.REJECT),
  executeMeetingProposal: invoke(RPC_CHANNELS.meetingProposals.EXECUTE),
  meetingProposalStatus: invoke(RPC_CHANNELS.meetingProposals.STATUS),
  ...
  getServerHealth: invoke(RPC_CHANNELS.server.GET_HEALTH),
  ...
  startVoiceCapture: invoke(RPC_CHANNELS.voice.CAPTURE_START),
  appendVoiceCaptureChunk: invoke(RPC_CHANNELS.voice.CAPTURE_CHUNK),
  stopVoiceCapture: invoke(RPC_CHANNELS.voice.CAPTURE_STOP),
  cancelVoiceCapture: invoke(RPC_CHANNELS.voice.CAPTURE_CANCEL),
  listVoiceRecordings: invoke(RPC_CHANNELS.voice.LIST),
  getVoiceCaptureStatus: invoke(RPC_CHANNELS.voice.STATUS),
  deleteVoiceRecording: invoke(RPC_CHANNELS.voice.DELETE),
  favoriteVoiceRecording: invoke(RPC_CHANNELS.voice.FAVORITE),
  getVoiceArchiveDir: invoke(RPC_CHANNELS.voice.ARCHIVE_DIR),
  getVoiceRecordingAudio: invoke(RPC_CHANNELS.voice.GET_AUDIO),
  retranscribeVoiceRecording: invoke(RPC_CHANNELS.voice.RETRANSCRIBE),
  exportVoiceRecording: invoke(RPC_CHANNELS.voice.EXPORT),
  selectVoiceRevision: invoke(RPC_CHANNELS.voice.SELECT_REVISION),
  editVoiceTranscript: invoke(RPC_CHANNELS.voice.EDIT_TRANSCRIPT),
  setVoiceOverlayVisible: invoke(RPC_CHANNELS.voice.SET_OVERLAY),
  rebindVoiceHotkeys: invoke(RPC_CHANNELS.voice.REBIND_HOTKEYS),
  dispatchVoiceCommand: invoke(RPC_CHANNELS.voice.COMMAND),
  speakVoice: invoke(RPC_CHANNELS.voice.SPEAK),
  onVoiceChanged: listener(RPC_CHANNELS.voice.CHANGED),
  onVoiceCommand: listener(RPC_CHANNELS.voice.COMMAND),
  onVoiceCaptureChanged: listener(RPC_CHANNELS.voice.CAPTURE_CHANGED),
