...
[RX-DOC-0004](RX-DOC-0004-security.md): находок **8** — Высокая: 1, Средняя: 4, Низкая: 3. Закрыто: `RX-SEC-0001`, `RX-SEC-0002`, `RX-SEC-0003`, `RX-SEC-0007`. Задачи: блок 0300–0399 в [списке](RX-DOC-0023-tasks.md).
