...
export const MEETING_AGENTS_GATE_CASES: readonly Omit<ReleaseCase, 'status' | 'live'>[] = [
  { id: 'm0-native-task-note', issue: 357, milestone: 'M0', evidenceLevel: 'N5', notes: 'parent #356 not closed by this gate' },
  { id: 'i017-tracker-stubs', issue: 373, milestone: 'M1', evidenceLevel: 'U1', notes: 'fail-closed GitHub/Linear stubs' },
  { id: 'i020-conation-capabilities', issue: 376, milestone: 'M2', evidenceLevel: 'U1', notes: 'AUD #333 still blocked' },
  { id: 'i024-mail-live', issue: 380, milestone: 'M2', evidenceLevel: 'L4', notes: 'live Mail Conation not claimed' },
  { id: 'i025-crm-live', issue: 381, milestone: 'M2', evidenceLevel: 'L4', notes: 'live CRM Conation not claimed' },
  { id: 'i026-calendar-live', issue: 382, milestone: 'M2', evidenceLevel: 'L4', notes: 'live Calendar Conation not claimed' },
  { id: 'i033-rooms', issue: 389, milestone: 'M3', evidenceLevel: 'N5', notes: 'SFU undecided' },
]
