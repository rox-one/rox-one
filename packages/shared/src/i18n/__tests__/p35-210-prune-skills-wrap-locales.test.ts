...
const KEY = 'toast.failedToPruneSkills' as const

const EN_VALUE = 'Failed to archive unused skills'
const RU_VALUE = 'Не удалось архивировать навыки'
...
describe('leftover Russian скилл wrapping in ru toast.failedToPruneSkills', () => {
