...
const KEY = 'toast.pagePreviewFailed'
const RU_VALUE = 'Не удалось обновить предпросмотр'
const EN_VALUE = "Couldn't refresh preview"
...
describe('P35-233 leftover Russian превью wrapping on toast.pagePreviewFailed', () => {
  ...
  it('wraps leftover превью as sibling предпросмотр on pagePreviewFailed only', () => {
    ...
    expect(ru[KEY]).not.toBe('Не удалось обновить превью')
  })
