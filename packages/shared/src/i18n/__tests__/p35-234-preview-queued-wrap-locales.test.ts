...
const KEY = 'toast.pagePreviewQueued'
const RU_VALUE = 'Обновляем предпросмотр…'
const EN_VALUE = 'Refreshing preview…'
...
describe('P35-234 leftover Russian превью wrapping on toast.pagePreviewQueued', () => {
  ...
  it('wraps leftover превью as sibling предпросмотр on pagePreviewQueued only', () => {
    ...
    expect(ru[KEY]).not.toBe('Обновляем превью…')
  })
