...
const KEY = 'cli.command.ask.useCase'
const LEFTOVER_CALQUE = 'бейдж'
const SIBLING_CHROME = 'значок'
const NATIVE_KEEP = 'Нативный контроль'

describe('P35-238 leftover Russian бейдж wrapping on cli.command.ask.useCase', () => {
  ...
  it('resolves English through setupI18n after changeLanguage(en)', async () => {
    ...
    expect(i18n.t(KEY)).toBe('Confirm sensitive tools before they run. Native control: permission badge.')
