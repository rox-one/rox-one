...
const KEY = 'settings.input.voiceModeImprove'
const RU_WRAPPED = 'Улучшить запрос'
const EN_VALUE = 'Improve prompt'

describe('P35-287 leftover Russian промпт wrapping on settings.input.voiceModeImprove', () => {
