...
const KEY = 'collection.slice.save'
const RU_WRAPPED = 'Сохранить срез'
const EN_VALUE = 'Save slice'

describe('P35-358 leftover Russian слайс wrapping on collection.slice.save', () => {
