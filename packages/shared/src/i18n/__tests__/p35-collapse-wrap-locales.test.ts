...
const WRAPPED_RU: Record<string, string> = {
  ...
  "cli.command.compact.useCase": "Сжать историю, чтобы освободить бюджет токенов. Нативный контроль: слэш-меню поля чата.",
  ...
  "settings.account.event.cloudRunImported": "Облачный ран импортирован",
  ...
  "settings.permissions.description": "Правила режима Обзор",
