...
const WRAPPED_RU: Record<string, string> = {
  ...
  "settings.orgs.inviteDesc": "Пригласите по почте или имени пользователя. Приглашение хранится на этом устройстве. Письмо не отправляется. Погашение локально или через URL сервера Rox, если он задан.",
