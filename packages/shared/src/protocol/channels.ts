...
export const RPC_CHANNELS = {
  ...
  personalTasks: {
    LOAD: 'personalTasks:load',
    SAVE: 'personalTasks:save',
  },
  workspaces: {
    GET: 'workspaces:get',
  ...
  voice: {
    ...
    CAPTURE_START: 'voice:captureStart',
    CAPTURE_CHUNK: 'voice:captureChunk',
    CAPTURE_STOP: 'voice:captureStop',
    CAPTURE_CANCEL: 'voice:captureCancel',
    STATUS: 'voice:status',
    LIST: 'voice:list',
    COMMAND: 'voice:command',
    CAPTURE_CHANGED: 'voice:captureChanged',
    DELETE: 'voice:delete',
    FAVORITE: 'voice:favorite',
    ARCHIVE_DIR: 'voice:archiveDir',
    SET_OVERLAY: 'voice:setOverlay',
    REBIND_HOTKEYS: 'voice:rebindHotkeys',
    GET_AUDIO: 'voice:getAudio',
    RETRANSCRIBE: 'voice:retranscribe',
    EXPORT: 'voice:export',
    SELECT_REVISION: 'voice:selectRevision',
    EDIT_TRANSCRIPT: 'voice:editTranscript',
  },
  environment: {
    GET: 'environment:get',
  ...
  meetingAgents: {
    LIST: 'meetingAgents:list',
    CONFIGURE: 'meetingAgents:configure',
    READINESS: 'meetingAgents:readiness',
    ASK: 'meetingAgents:ask',
    RUN_SKILL: 'meetingAgents:runSkill',
  },
  meetingProposals: {
    LIST: 'meetingProposals:list',
    CLARIFY: 'meetingProposals:clarify',
    APPROVE: 'meetingProposals:approve',
    REJECT: 'meetingProposals:reject',
    EXECUTE: 'meetingProposals:execute',
  ...
  meetings: {
    ...
    PAUSE: 'meetings:pause',
    RESUME: 'meetings:resume',
    STOP: 'meetings:stop',
    SEARCH: 'meetings:search',
    SEGMENTS: 'meetings:segments',
